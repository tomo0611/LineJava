...
public class CoinHistory implements org.apache.thrift.TBase<CoinHistory, CoinHistory._Fields>, java.io.Serializable, Cloneable, Comparable<CoinHistory> {
  ...
  static {
    schemes.put(StandardScheme.class, new CoinHistoryStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CoinHistoryTupleSchemeFactory());
  }
  ...
  public String paySeq; // required
  public String currency; // required
  public String currencySign; // required
  public String displayPrice; // required
  ...
  public void unsetPayDate() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __PAYDATE_ISSET_ID);
  }

  /** Returns true if field payDate is set (has been assigned a value) and false otherwise */
  public boolean isSetPayDate() {
    return EncodingUtils.testBit(__isset_bitfield, __PAYDATE_ISSET_ID);
  }

  public void setPayDateIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __PAYDATE_ISSET_ID, value);
  }
  ...
  public void unsetCoinBalance() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __COINBALANCE_ISSET_ID);
  }

  /** Returns true if field coinBalance is set (has been assigned a value) and false otherwise */
  public boolean isSetCoinBalance() {
    return EncodingUtils.testBit(__isset_bitfield, __COINBALANCE_ISSET_ID);
  }

  public void setCoinBalanceIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __COINBALANCE_ISSET_ID, value);
  }
  ...
  public CoinHistory setPrice(String price) {
    this.price = price;
    return this;
  }
  ...
  public CoinHistory setTitle(String title) {
    this.title = title;
    return this;
  }
  ...
  public CoinHistory setPaySeq(String paySeq) {
    this.paySeq = paySeq;
    return this;
  }
  ...
  public CoinHistory setCurrency(String currency) {
    this.currency = currency;
    return this;
  }
  ...
  public CoinHistory setCurrencySign(String currencySign) {
    this.currencySign = currencySign;
    return this;
  }
  ...
  public CoinHistory setDisplayPrice(String displayPrice) {
    this.displayPrice = displayPrice;
    return this;
  }
  ...
  public CoinHistory setChannelId(String channelId) {
    this.channelId = channelId;
    return this;
  }
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case PAY_DATE:
      return Long.valueOf(getPayDate());

    case COIN_BALANCE:
      return Integer.valueOf(getCoinBalance());
    ...
    case REFUND:
      return Boolean.valueOf(isRefund());
  ...
  public int compareTo(CoinHistory other) {
    ...
    lastComparison = Boolean.valueOf(isSetCoinBalance()).compareTo(other.isSetCoinBalance());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCoinBalance()) {
    ...
    lastComparison = Boolean.valueOf(isSetPaySeq()).compareTo(other.isSetPaySeq());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPaySeq()) {
    ...
    lastComparison = Boolean.valueOf(isSetCurrencySign()).compareTo(other.isSetCurrencySign());
    if (lastComparison != 0) {
      return lastComparison;
    }
  ...
  private static class CoinHistoryStandardSchemeFactory implements SchemeFactory {
    public CoinHistoryStandardScheme getScheme() {
      return new CoinHistoryStandardScheme();
    }
  }

  private static class CoinHistoryStandardScheme extends StandardScheme<CoinHistory> {
  ...
  private static class CoinHistoryTupleSchemeFactory implements SchemeFactory {
    public CoinHistoryTupleScheme getScheme() {
      return new CoinHistoryTupleScheme();
    }
  }

  private static class CoinHistoryTupleScheme extends TupleScheme<CoinHistory> {
