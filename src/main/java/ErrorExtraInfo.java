...
public class ErrorExtraInfo implements org.apache.thrift.TBase<ErrorExtraInfo, ErrorExtraInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ErrorExtraInfo> {
  ...
  static {
    schemes.put(StandardScheme.class, new ErrorExtraInfoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ErrorExtraInfoTupleSchemeFactory());
  }
  ...
  public int compareTo(ErrorExtraInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetPreconditionFailedExtraInfo()).compareTo(other.isSetPreconditionFailedExtraInfo());
    if (lastComparison != 0) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ErrorExtraInfo(");
    boolean first = true;
  ...
  private static class ErrorExtraInfoStandardSchemeFactory implements SchemeFactory {
    public ErrorExtraInfoStandardScheme getScheme() {
      return new ErrorExtraInfoStandardScheme();
    }
  }

  private static class ErrorExtraInfoStandardScheme extends StandardScheme<ErrorExtraInfo> {
  ...
  private static class ErrorExtraInfoTupleSchemeFactory implements SchemeFactory {
    public ErrorExtraInfoTupleScheme getScheme() {
      return new ErrorExtraInfoTupleScheme();
    }
  }

  private static class ErrorExtraInfoTupleScheme extends TupleScheme<ErrorExtraInfo> {
