...
public class ProductSimpleList implements org.apache.thrift.TBase<ProductSimpleList, ProductSimpleList._Fields>, java.io.Serializable, Cloneable, Comparable<ProductSimpleList> {
  ...
  public List<ProductSimple> productList; // required
  ...
  public ProductSimpleList setProductList(List<ProductSimple> productList) {
    this.productList = productList;
    return this;
  }
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case REINVOKE_HOUR:
      return Integer.valueOf(getReinvokeHour());

    case LAST_VERSION_SEQ:
      return Long.valueOf(getLastVersionSeq());

    case PRODUCT_LIST:
      return getProductList();

    case RECENT_NEW_RELEASE_DATE:
      return Long.valueOf(getRecentNewReleaseDate());

    case RECENT_EVENT_RELEASE_DATE:
      return Long.valueOf(getRecentEventReleaseDate());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.productList = new ArrayList<ProductSimple>(_list264.size);
                for (int _i265 = 0; _i265 < _list264.size; ++_i265)
                {
                  ProductSimple _elem266;
                  _elem266 = new ProductSimple();
                  _elem266.read(iprot);
                  struct.productList.add(_elem266);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ProductSimpleList struct) throws org.apache.thrift.TException {
      ...
      if (struct.productList != null) {
        oprot.writeFieldBegin(PRODUCT_LIST_FIELD_DESC);
        {
          ...
          for (ProductSimple _iter267 : struct.productList)
          {
      ...
      if (struct.isSetProductList()) {
        {
          ...
          for (ProductSimple _iter268 : struct.productList)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.productList = new ArrayList<ProductSimple>(_list269.size);
          for (int _i270 = 0; _i270 < _list269.size; ++_i270)
          {
            ProductSimple _elem271;
            _elem271 = new ProductSimple();
            _elem271.read(iprot);
            struct.productList.add(_elem271);
          }
        }
        struct.setProductListIsSet(true);
      }
