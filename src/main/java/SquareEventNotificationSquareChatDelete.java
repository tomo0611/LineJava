...
public class SquareEventNotificationSquareChatDelete implements org.apache.thrift.TBase<SquareEventNotificationSquareChatDelete, SquareEventNotificationSquareChatDelete._Fields>, java.io.Serializable, Cloneable, Comparable<SquareEventNotificationSquareChatDelete> {
  ...
  static {
    schemes.put(StandardScheme.class, new SquareEventNotificationSquareChatDeleteStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SquareEventNotificationSquareChatDeleteTupleSchemeFactory());
  }

  public String squareChatMid; // required
  public String squareChatName; // required
  ...
  public SquareEventNotificationSquareChatDelete setSquareChatMid(String squareChatMid) {
    this.squareChatMid = squareChatMid;
    return this;
  }
  ...
  public SquareEventNotificationSquareChatDelete setSquareChatName(String squareChatName) {
    this.squareChatName = squareChatName;
    return this;
  }
  ...
  public SquareEventNotificationSquareChatDelete setProfileImageObsHash(String profileImageObsHash) {
    this.profileImageObsHash = profileImageObsHash;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case SQUARE_CHAT_NAME:
      if (value == null) {
        ...
        setSquareChatName((String)value);
      }
      break;
  ...
  public int compareTo(SquareEventNotificationSquareChatDelete other) {
    ...
    lastComparison = Boolean.valueOf(isSetSquareChatName()).compareTo(other.isSetSquareChatName());
    if (lastComparison != 0) {
      return lastComparison;
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SquareEventNotificationSquareChatDelete(");
    boolean first = true;
  ...
  private static class SquareEventNotificationSquareChatDeleteStandardSchemeFactory implements SchemeFactory {
  ...
  private static class SquareEventNotificationSquareChatDeleteStandardScheme extends StandardScheme<SquareEventNotificationSquareChatDelete> {
  ...
  private static class SquareEventNotificationSquareChatDeleteTupleSchemeFactory implements SchemeFactory {
  ...
  private static class SquareEventNotificationSquareChatDeleteTupleScheme extends TupleScheme<SquareEventNotificationSquareChatDelete> {
