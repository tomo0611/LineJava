...
public class FindSquareByInvitationTicketResponse implements org.apache.thrift.TBase<FindSquareByInvitationTicketResponse, FindSquareByInvitationTicketResponse._Fields>, java.io.Serializable, Cloneable, Comparable<FindSquareByInvitationTicketResponse> {
  ...
  static {
    schemes.put(StandardScheme.class, new FindSquareByInvitationTicketResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new FindSquareByInvitationTicketResponseTupleSchemeFactory());
  }
  ...
  public int compareTo(FindSquareByInvitationTicketResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetMyMembership()).compareTo(other.isSetMyMembership());
    if (lastComparison != 0) {
      return lastComparison;
    }
  ...
  private static class FindSquareByInvitationTicketResponseStandardSchemeFactory implements SchemeFactory {
  ...
  private static class FindSquareByInvitationTicketResponseStandardScheme extends StandardScheme<FindSquareByInvitationTicketResponse> {
  ...
  private static class FindSquareByInvitationTicketResponseTupleSchemeFactory implements SchemeFactory {
  ...
  private static class FindSquareByInvitationTicketResponseTupleScheme extends TupleScheme<FindSquareByInvitationTicketResponse> {
