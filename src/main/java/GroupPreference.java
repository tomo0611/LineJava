...
public class GroupPreference implements org.apache.thrift.TBase<GroupPreference, GroupPreference._Fields>, java.io.Serializable, Cloneable, Comparable<GroupPreference> {
  ...
  static {
    schemes.put(StandardScheme.class, new GroupPreferenceStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GroupPreferenceTupleSchemeFactory());
  }

  public String invitationTicket; // required
  ...
  public GroupPreference setInvitationTicket(String invitationTicket) {
    this.invitationTicket = invitationTicket;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case INVITATION_TICKET:
      if (value == null) {
        ...
        setInvitationTicket((String)value);
      }
      break;
  ...
  public int compareTo(GroupPreference other) {
    ...
    lastComparison = Boolean.valueOf(isSetInvitationTicket()).compareTo(other.isSetInvitationTicket());
    if (lastComparison != 0) {
  ...
  private static class GroupPreferenceStandardSchemeFactory implements SchemeFactory {
    public GroupPreferenceStandardScheme getScheme() {
      return new GroupPreferenceStandardScheme();
    }
  }

  private static class GroupPreferenceStandardScheme extends StandardScheme<GroupPreference> {
  ...
  private static class GroupPreferenceTupleSchemeFactory implements SchemeFactory {
    public GroupPreferenceTupleScheme getScheme() {
      return new GroupPreferenceTupleScheme();
    }
  }

  private static class GroupPreferenceTupleScheme extends TupleScheme<GroupPreference> {
