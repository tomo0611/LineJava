...
public class SquareAuthority implements org.apache.thrift.TBase<SquareAuthority, SquareAuthority._Fields>, java.io.Serializable, Cloneable, Comparable<SquareAuthority> {
  ...
  static {
    schemes.put(StandardScheme.class, new SquareAuthorityStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SquareAuthorityTupleSchemeFactory());
  }
  ...
  public SquareAuthority setSquareMid(String squareMid) {
    this.squareMid = squareMid;
    return this;
  }
  ...
  public int compareTo(SquareAuthority other) {
    ...
    lastComparison = Boolean.valueOf(isSetUpdateSquareProfile()).compareTo(other.isSetUpdateSquareProfile());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetInviteNewMember()).compareTo(other.isSetInviteNewMember());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetApproveJoinRequest()).compareTo(other.isSetApproveJoinRequest());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetCreatePost()).compareTo(other.isSetCreatePost());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCreatePost()) {
    ...
    lastComparison = Boolean.valueOf(isSetCreateOpenSquareChat()).compareTo(other.isSetCreateOpenSquareChat());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetDeleteSquareChatOrPost()).compareTo(other.isSetDeleteSquareChatOrPost());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetRemoveSquareMember()).compareTo(other.isSetRemoveSquareMember());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetGrantRole()).compareTo(other.isSetGrantRole());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetGrantRole()) {
    ...
    lastComparison = Boolean.valueOf(isSetEnableInvitationTicket()).compareTo(other.isSetEnableInvitationTicket());
    if (lastComparison != 0) {
      return lastComparison;
    }
  ...
  private static class SquareAuthorityStandardSchemeFactory implements SchemeFactory {
    public SquareAuthorityStandardScheme getScheme() {
      return new SquareAuthorityStandardScheme();
    }
  }

  private static class SquareAuthorityStandardScheme extends StandardScheme<SquareAuthority> {
  ...
  private static class SquareAuthorityTupleSchemeFactory implements SchemeFactory {
    public SquareAuthorityTupleScheme getScheme() {
      return new SquareAuthorityTupleScheme();
    }
  }

  private static class SquareAuthorityTupleScheme extends TupleScheme<SquareAuthority> {
