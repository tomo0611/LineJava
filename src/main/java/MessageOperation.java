...
public class MessageOperation implements org.apache.thrift.TBase<MessageOperation, MessageOperation._Fields>, java.io.Serializable, Cloneable, Comparable<MessageOperation> {
  ...
  static {
    schemes.put(StandardScheme.class, new MessageOperationStandardSchemeFactory());
    schemes.put(TupleScheme.class, new MessageOperationTupleSchemeFactory());
  }
  ...
  public MessageOperation setParam1(String param1) {
    this.param1 = param1;
    return this;
  }
  ...
  public MessageOperation setParam2(String param2) {
    this.param2 = param2;
    return this;
  }
  ...
  public MessageOperation setParam3(String param3) {
    this.param3 = param3;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("MessageOperation(");
    boolean first = true;
  ...
  private static class MessageOperationStandardSchemeFactory implements SchemeFactory {
    public MessageOperationStandardScheme getScheme() {
      return new MessageOperationStandardScheme();
    }
  }

  private static class MessageOperationStandardScheme extends StandardScheme<MessageOperation> {
  ...
  private static class MessageOperationTupleSchemeFactory implements SchemeFactory {
    public MessageOperationTupleScheme getScheme() {
      return new MessageOperationTupleScheme();
    }
  }

  private static class MessageOperationTupleScheme extends TupleScheme<MessageOperation> {
