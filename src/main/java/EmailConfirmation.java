...
public class EmailConfirmation implements org.apache.thrift.TBase<EmailConfirmation, EmailConfirmation._Fields>, java.io.Serializable, Cloneable, Comparable<EmailConfirmation> {
  ...
  public EmailConfirmation setEmail(String email) {
    this.email = email;
    return this;
  }
  ...
  public EmailConfirmation setPassword(String password) {
    this.password = password;
    return this;
  }
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case USE_PASSWORD_SET:
      return Boolean.valueOf(isUsePasswordSet());
    ...
    case IGNORE_DUPLICATION:
      return Boolean.valueOf(isIgnoreDuplication());
