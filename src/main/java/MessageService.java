...
public class MessageService {
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_getLastReadMessageIds(String chatId) throws org.apache.thrift.TException
    {
    ...
    public void send_multiGetLastReadMessageIds(List<String> chatIds) throws org.apache.thrift.TException
    {
    ...
    public List<LastReadMessageIds> recv_multiGetLastReadMessageIds() throws TalkException, org.apache.thrift.TException
    {
  ...
  public static class fetchMessageOperations_args implements org.apache.thrift.TBase<fetchMessageOperations_args, fetchMessageOperations_args._Fields>, java.io.Serializable, Cloneable, Comparable<fetchMessageOperations_args>   {
    ...
    public Object getFieldValue(_Fields field) {
      switch (field) {
      case LOCAL_REVISION:
        return Long.valueOf(getLocalRevision());

      case LAST_OP_TIMESTAMP:
        return Long.valueOf(getLastOpTimestamp());
  ...
  public static class getLastReadMessageIds_args implements org.apache.thrift.TBase<getLastReadMessageIds_args, getLastReadMessageIds_args._Fields>, java.io.Serializable, Cloneable, Comparable<getLastReadMessageIds_args>   {
    ...
    public getLastReadMessageIds_args setChatId(String chatId) {
      this.chatId = chatId;
      return this;
    }
  ...
  public static class multiGetLastReadMessageIds_args implements org.apache.thrift.TBase<multiGetLastReadMessageIds_args, multiGetLastReadMessageIds_args._Fields>, java.io.Serializable, Cloneable, Comparable<multiGetLastReadMessageIds_args>   {
    ...
    public List<String> chatIds; // required
    ...
    public multiGetLastReadMessageIds_args setChatIds(List<String> chatIds) {
      this.chatIds = chatIds;
      return this;
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.chatIds = new ArrayList<String>(_list816.size);
                  for (int _i817 = 0; _i817 < _list816.size; ++_i817)
                  {
                    String _elem818;
                    _elem818 = iprot.readString();
                    struct.chatIds.add(_elem818);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, multiGetLastReadMessageIds_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.chatIds != null) {
          oprot.writeFieldBegin(CHAT_IDS_FIELD_DESC);
          {
            ...
            for (String _iter819 : struct.chatIds)
            {
        ...
        if (struct.isSetChatIds()) {
          {
            ...
            for (String _iter820 : struct.chatIds)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.chatIds = new ArrayList<String>(_list821.size);
            for (int _i822 = 0; _i822 < _list821.size; ++_i822)
            {
              String _elem823;
              _elem823 = iprot.readString();
              struct.chatIds.add(_elem823);
            }
          }
          struct.setChatIdsIsSet(true);
        }
  ...
  public static class multiGetLastReadMessageIds_result implements org.apache.thrift.TBase<multiGetLastReadMessageIds_result, multiGetLastReadMessageIds_result._Fields>, java.io.Serializable, Cloneable, Comparable<multiGetLastReadMessageIds_result>   {
    ...
    public List<LastReadMessageIds> success; // required
    public TalkException e; // required
    ...
    public multiGetLastReadMessageIds_result setSuccess(List<LastReadMessageIds> success) {
      this.success = success;
      return this;
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<LastReadMessageIds>(_list824.size);
                  for (int _i825 = 0; _i825 < _list824.size; ++_i825)
                  {
                    LastReadMessageIds _elem826;
                    _elem826 = new LastReadMessageIds();
                    _elem826.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, multiGetLastReadMessageIds_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (LastReadMessageIds _iter827 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (LastReadMessageIds _iter828 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<LastReadMessageIds>(_list829.size);
            for (int _i830 = 0; _i830 < _list829.size; ++_i830)
            {
              LastReadMessageIds _elem831;
              _elem831 = new LastReadMessageIds();
              _elem831.read(iprot);
