...
public class SquareMember implements org.apache.thrift.TBase<SquareMember, SquareMember._Fields>, java.io.Serializable, Cloneable, Comparable<SquareMember> {
  ...
  static {
    schemes.put(StandardScheme.class, new SquareMemberStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SquareMemberTupleSchemeFactory());
  }
  ...
  public String joinMessage; // required
  ...
  public SquareMember setSquareMemberMid(String squareMemberMid) {
    this.squareMemberMid = squareMemberMid;
    return this;
  }
  ...
  public SquareMember setSquareMid(String squareMid) {
    this.squareMid = squareMid;
    return this;
  }
  ...
  public SquareMember setDisplayName(String displayName) {
    this.displayName = displayName;
    return this;
  }
  ...
  public SquareMember setProfileImageObsHash(String profileImageObsHash) {
    this.profileImageObsHash = profileImageObsHash;
    return this;
  }
  ...
  public void unsetAbleToReceiveMessage() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __ABLETORECEIVEMESSAGE_ISSET_ID);
  }
  ...
  public boolean isSetAbleToReceiveMessage() {
    return EncodingUtils.testBit(__isset_bitfield, __ABLETORECEIVEMESSAGE_ISSET_ID);
  }

  public void setAbleToReceiveMessageIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __ABLETORECEIVEMESSAGE_ISSET_ID, value);
  }
  ...
  public SquareMember setJoinMessage(String joinMessage) {
    this.joinMessage = joinMessage;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case ABLE_TO_RECEIVE_MESSAGE:
      if (value == null) {
        ...
        setAbleToReceiveMessage((Boolean)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case ABLE_TO_RECEIVE_MESSAGE:
      return Boolean.valueOf(isAbleToReceiveMessage());
  ...
  public int compareTo(SquareMember other) {
    ...
    lastComparison = Boolean.valueOf(isSetAbleToReceiveMessage()).compareTo(other.isSetAbleToReceiveMessage());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetJoinMessage()).compareTo(other.isSetJoinMessage());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetJoinMessage()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SquareMember(");
    boolean first = true;
  ...
  private static class SquareMemberStandardSchemeFactory implements SchemeFactory {
    public SquareMemberStandardScheme getScheme() {
      return new SquareMemberStandardScheme();
    }
  }

  private static class SquareMemberStandardScheme extends StandardScheme<SquareMember> {
  ...
  private static class SquareMemberTupleSchemeFactory implements SchemeFactory {
    public SquareMemberTupleScheme getScheme() {
      return new SquareMemberTupleScheme();
    }
  }

  private static class SquareMemberTupleScheme extends TupleScheme<SquareMember> {
