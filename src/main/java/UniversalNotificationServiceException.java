...
public class UniversalNotificationServiceException extends TException implements org.apache.thrift.TBase<UniversalNotificationServiceException, UniversalNotificationServiceException._Fields>, java.io.Serializable, Cloneable, Comparable<UniversalNotificationServiceException> {
  ...
  public UniversalNotificationServiceException setReason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public UniversalNotificationServiceException setParameterMap(Map<String,String> parameterMap) {
    this.parameterMap = parameterMap;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.parameterMap = new HashMap<String,String>(2*_map398.size);
                for (int _i399 = 0; _i399 < _map398.size; ++_i399)
                {
                  ...
                  struct.parameterMap.put(_key400, _val401);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UniversalNotificationServiceException struct) throws org.apache.thrift.TException {
      ...
      if (struct.parameterMap != null) {
        oprot.writeFieldBegin(PARAMETER_MAP_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, String> _iter402 : struct.parameterMap.entrySet())
          {
      ...
      if (struct.isSetParameterMap()) {
        {
          ...
          for (Map.Entry<String, String> _iter403 : struct.parameterMap.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.parameterMap = new HashMap<String,String>(2*_map404.size);
          for (int _i405 = 0; _i405 < _map404.size; ++_i405)
          {
            ...
            struct.parameterMap.put(_key406, _val407);
          }
        }
        struct.setParameterMapIsSet(true);
      }
