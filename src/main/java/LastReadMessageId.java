...
public class LastReadMessageId implements org.apache.thrift.TBase<LastReadMessageId, LastReadMessageId._Fields>, java.io.Serializable, Cloneable, Comparable<LastReadMessageId> {
  ...
  static {
    schemes.put(StandardScheme.class, new LastReadMessageIdStandardSchemeFactory());
    schemes.put(TupleScheme.class, new LastReadMessageIdTupleSchemeFactory());
  }

  public String mid; // required
  public String lastReadMessageId; // required
  ...
  public LastReadMessageId setMid(String mid) {
    this.mid = mid;
    return this;
  }
  ...
  public LastReadMessageId setLastReadMessageId(String lastReadMessageId) {
    this.lastReadMessageId = lastReadMessageId;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case LAST_READ_MESSAGE_ID:
      if (value == null) {
        ...
        setLastReadMessageId((String)value);
      }
      break;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("LastReadMessageId(");
    boolean first = true;
  ...
  private static class LastReadMessageIdStandardSchemeFactory implements SchemeFactory {
    public LastReadMessageIdStandardScheme getScheme() {
      return new LastReadMessageIdStandardScheme();
    }
  }

  private static class LastReadMessageIdStandardScheme extends StandardScheme<LastReadMessageId> {
  ...
  private static class LastReadMessageIdTupleSchemeFactory implements SchemeFactory {
    public LastReadMessageIdTupleScheme getScheme() {
      return new LastReadMessageIdTupleScheme();
    }
  }

  private static class LastReadMessageIdTupleScheme extends TupleScheme<LastReadMessageId> {
